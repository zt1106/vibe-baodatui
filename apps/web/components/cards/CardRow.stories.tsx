...
import {
  AddRemoveAnimatedStory,
  AnimatedMetadataStory,
  IncomingFromAvatarStory,
  TransferBetweenRowsStory
} from './CardRow.story-interactives';
import { TARGET_ROW_ANGLE, TARGET_ROW_CURVE, TARGET_ROW_OVERLAP } from './CardRow.story-helpers';
...
export const AnimatedMetadata: Story = {
  render: AnimatedMetadataStory
};

export const AddRemoveAnimated: Story = {
  render: AddRemoveAnimatedStory
};

export const TransferBetweenRows: Story = {
  render: TransferBetweenRowsStory
};
...
export const IncomingFromAvatar: Story = {
  ...
  render: IncomingFromAvatarStory
};
